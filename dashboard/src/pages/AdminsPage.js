      ...
      <div className="ml-[230px] ">
        ...
        <div className="mt-8 flex flex-col bg-white p-4 items-center w-[60%]">
          <input
            ...
            className="w-[660px] outline-none border border-gray-700 h-10 p-2 mb-2 rounded-md placeholder:text-gray-600"
          />
          <input
            type="text"
            placeholder="confirm password"
            className="w-[660px] outline-none border border-gray-700 h-10 p-2 rounded-md mt-2 placeholder:text-gray-600"
          />
